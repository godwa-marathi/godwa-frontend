                            ...
                            >
                                ...
                                {viewMode !== "meaning" && (
                                    <>
                                        ...
                                        {showRoman && romanLine && (
                                            <div className={`text-[17px] min-[360px]:text-[18px] sm:text-[19px] md:text-[21px] lg:text-[22px] font-lora italic font-medium text-foreground/90 leading-[1.85] py-0.5 tracking-[0.015em] max-w-[40ch] mx-auto ${
                                                alignment === "justify" 
