...
export const translations: Record<Language, TranslationDictionary> = {
    roman: {
        ...
        about_title: "About Us — Godwa Space",
        about_subtitle: "Godwa Space — A Digital Home for Marathi Poetry",
        about_hero_desc_1: "Godwa Space is a digital sanctuary for Marathi poetry and literature.",
        about_hero_desc_2: "Our mission is to preserve the rich heritage of Marathi poetry, understand its depth, and make it accessible to everyone—word by word—whether you are a lifelong reader, a language learner, or simply curious about Maharashtra's literary traditions.",
        about_hero_desc_3: "We believe no one should be kept away from a beautiful poem because of an unfamiliar vocabulary, a regional dialect, or a script barrier.",
        about_btn_explore: "Explore Poems",
        about_btn_poets: "Poets Directory",
        about_vision_preserve_title: "Preserve",
        about_vision_preserve_desc: "Documenting classic and contemporary Marathi poems, regional dialects, and rare literary works before they are lost to time.",
        about_vision_understand_title: "Understand",
        about_vision_understand_desc: "Providing word-by-word meanings, contextual interpretations, and Boli Bhasha explanations directly within the poem text.",
        about_vision_connect_title: "Connect",
        about_vision_connect_desc: "Enabling readers worldwide—regardless of script fluency—to read Marathi poetry in Devanagari or Roman transliteration.",
        about_unique_tag: "Features",
        about_unique_title: "What Makes Godwa Space Unique?",
        about_feat_1_title: "Read in Devanagari or Roman",
        about_feat_1_desc: "Every poem is available in Marathi (Devanagari) and Roman Marathi transliteration. Switch between them instantly—no script barrier.",
        about_feat_2_title: "Word-by-Word Meanings",
        about_feat_2_desc: "Tap any word to instantly see its meaning. No dictionary needed—the context is right inside the poem.",
        about_feat_3_title: "Contextual Interpretation",
        about_feat_3_desc: "Instead of dictionary definitions, Godwa Space explains words as they are actually used in the poem—what the poet intended to express.",
        about_feat_4_title: "Boli Bhasha Coverage",
        about_feat_4_desc: "Classical Marathi, Sanskrit vocabulary, regional dialects, historical expressions—Godwa Space covers them all so no word is left unexplained.",
        about_feat_5_title: "Poet Profiles",
        about_feat_5_desc: "Learn about the poets—their lives, their eras, and their literary contributions—alongside their work.",
        about_feat_6_title: "Chhanda (Metre) Information",
        about_feat_6_desc: "Understand the poetic metre of each poem. Explore poems by genre, mood, and Chhanda.",
        about_vocab_tag: "Literary Vocabulary",
        about_vocab_title: "The Words Behind Godwa Space",
        about_vocab_desc: "Marathi literature is rich with expressive words that carry deep emotional and cultural nuance. Here are a few examples:",
    },
    devanagari: {
